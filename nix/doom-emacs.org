...
6. [ ] projectile works.
  ...
  b. [ ] I can search for files by text content.
...
11. [ ] evil completely works
  ...
  b. [ ] ~:e~ completions use Counsel.
12. [ ] Check before leaving Emacs.
14. [ ] Holy mode has a different colored cursor.
15. [ ] Use Doom's modeline.
16. [ ] Relative line numbers work.
17. [ ] The scrollbar is hidden.
18. [ ] which-key is globally enabled.
19. [ ] My preferred font is used.
20. [ ] Tramp works.
