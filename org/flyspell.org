...
(use-package "flyspell"
  ...
  ;; Use the ido interface for a popup-like correction menu that shows
  ;; suggestions and actions (save to dict, accept for session/buffer, etc.).
  ;; flyspell-correct-ido is bundled with flyspell-correct.
