...
#+name: config/doom-theme-settings
...
#+name: config/after-load-theme-hook
#+begin_src emacs-lisp :results none :tangle no
...
<<config/doom-theme-settings>>
<<config/after-load-theme-hook>>
(use-package doom-themes
  ...
  ;; doom-themes-org-config is in doom-themes-ext-org.el, which is autoloaded
  ;; in the standard package system but not in the Nix setup (no
  ;; package-initialize).  Require it explicitly before calling.
