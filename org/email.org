...
#+begin_src emacs-lisp :results none :tangle no
(setq mu4e-trash-folder "/personal-gmail/personal-gmail-trash")
#+end_src
...
;; Left for reference. No longer needed now that we have mu4e-bookmark-define,
;; which replaces colliding bookmarks.
;; (setq mu4e-bookmarks
;;       (-remove (lambda (x)
;;                  (or
...
(mu4e-bookmark-define
  "maildir:/personal-gmail/Inbox"
  "inbox"
  ?i)
(mu4e-bookmark-define
  "maildir:/personal-gmail/Inbox AND date:today..now"
  "Today's inbox messages"
  ?t)
#+end_src

#+RESULTS: config/mu4e-add-bookmarks
| :name | Today's inbox messages | :query | maildir:/personal-gmail/Inbox AND date:today..now | :key         | 116 |      |     |
| :name | inbox                  | :query | maildir:/personal-gmail/Inbox                     | :key         | 105 |      |     |
