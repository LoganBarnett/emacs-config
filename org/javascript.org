...
*** local package executables
   ...
   #+name: config/javascript-get-node-modules-bin
...
#+name: config/javascript-use-checker-from-node-modules
#+BEGIN_SRC emacs-lisp :tangle no
...
#+name: config/javascript-find-flycheck-backends
#+BEGIN_SRC emacs-lisp :tangle no
...
**** flycheck checker order
     ...
     #+name: config/javascript-connect-flycheck-backends
     #+BEGIN_SRC emacs-lisp :tangle no
...
*** company
    ...
    :END:
#+name: config/javascript-use-company-backend-from-node-modules
#+BEGIN_SRC emacs-lisp :tangle no
...
#+name: config/javascript-find-company-backends
#+BEGIN_SRC emacs-lisp :tangle no
...
#+name: config/javascript-config-company-backends
#+BEGIN_SRC emacs-lisp :tangle no
...
#+name: config/javascript-flow-type-at-pos
#+BEGIN_SRC emacs-lisp :results none :tangle no
...
<<config/javascript-get-node-modules-bin>>
<<config/javascript-use-checker-from-node-modules>>
<<config/javascript-find-flycheck-backends>>
<<config/javascript-connect-flycheck-backends>>
<<config/javascript-use-company-backend-from-node-modules>>
<<config/javascript-find-company-backends>>
<<config/javascript-config-company-backends>>
...
*** js-mode
#+name: config/javascript-js-mode-reference
