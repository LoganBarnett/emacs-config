...
*** end of file
    ...
    I found these aren't respected because of =ws-butler=. It is very
    opinionated about this, but I find it obtrusive. The irony is =ws-butler=
    seeks to avoid obtrusiveness, but this is a deliberate decision.

    #+begin_src emacs-lisp :results none
      ;; This is just a copy of the original, sans `require-final-newline' ignoring.
      (defun custom/ws-butler-trim-eob-lines (orig-fun)
      ...
      (defun config/disable-final-newline-for-js ()
        ...
        (advice-add
         ...
         :override
         #'custom/ws-butler-trim-eob-lines
         )
        )
    #+end_src
