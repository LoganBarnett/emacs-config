              ...
              (let ((lines (split-string c "\n")))
                (mapcar (lambda (line)
                  (mapcar (lambda (time-segment)
                    (save-match-data
                      (if (string-match "\\[\\([0-9]\\{4\\}-[0-9]\\{2\\}-[0-9]\\{2\\}\\) \\w+ \\([0-9]\\{2\\}:[0-9]\\{2\\}\\)\\]" time-segment)
                        (concat (match-string 1 time-segment) " " (match-string 2 time-segment))
                        nil)
                      )
                    )
                  (split-string line "--"))
...
#+begin_src emacs-lisp :tangle no
  (message "%s" (time/get-work-logbook-entries (date-to-time "2018-06-11 00:00:00") (date-to-time "2018-06-15 00:00:00") "~/work-notes/nwea-log.org"))
#+end_src

#+RESULTS:
: (((2018-06-15 09:15 2018-06-15 16:04)) ((2018-06-14 08:33 2018-06-14 16:30)) ((2018-06-13 12:52 2018-06-13 16:50) (2018-06-13 08:30 2018-06-13 12:31)) ((2018-06-12 08:31 2018-06-12 17:14)))
