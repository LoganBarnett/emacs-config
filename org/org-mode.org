...
At some point org-mode started completing =[= with =]= and this cannot stand. If
this starts to grow, just throw in what we have in [[file:./prog-mode.org][prog-mode.org]]

#+name: config/org-mode-smart-parens-disable
#+begin_src emacs-lisp :results none :tangle no
(defun config/org-mode-smart-parens-disable ()
...
(use-package "org"
  ...
  (add-hook 'org-mode-hook #'config/org-mode-smart-parens-disable)
  :config
