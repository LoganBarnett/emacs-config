...
#+name: config/org-mode-insert-inactive-time-stamp-with-time
#+begin_src emacs-lisp :results none :tangle no
...
Wire it up to our key bindings.

#+name: config/org-mode-insert-inactive-time-stamp-with-time-keymap
...
(use-package "org"
  ...
  <<config/org-mode-insert-inactive-time-stamp-with-time-keymap>>
  ...
  (map!
   ...
   (:prefix ("d" . "date/time stamps")
    ...
    :desc "active timestamp" "t" #'org-timestamp
