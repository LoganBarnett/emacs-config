...
;; Code lifted from doomemacs/lisp/lib/projects.el (more or less verbatim).
;; This is to provide very important functionality used in other packages such
;; as `doom-project-root'.  Why these aren't part of projectile (or some other
;; package which enhances projectile) is not something I understand yet.
